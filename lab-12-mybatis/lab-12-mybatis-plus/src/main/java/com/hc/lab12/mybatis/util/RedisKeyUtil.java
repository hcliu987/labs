...
public class RedisKeyUtil {
   ...
   * @return
   */
  public static String getKey(String tableNamem, String majorKey, String majorKeyValue) {
    StringBuffer buffer = new StringBuffer();
    buffer.append(tableNamem).append(":");
    buffer.append(majorKey).append(":");
