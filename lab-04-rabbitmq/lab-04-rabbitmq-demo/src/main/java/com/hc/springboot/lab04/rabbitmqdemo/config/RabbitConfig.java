...
public class RabbitConfig {
  ...
  public static class DirectExchangeDemoConfiguration {
    ...
    /**
     * 创建binding Exchange：Demo01Message.EXCHANGE Routing key：Demo01Message.ROUTING_KEY
  ...
  public static class FanoutExchangeDemoConfiguration {
    ...
    /**
     * 创建binding a exchange: demo03message.exchange queue : demo03messgae.queue
     */
    @Bean
    ...
    /**
     * 创建binding b exchange: demo03message.exchange queue : demo03messgae.queue
     */
    @Bean
