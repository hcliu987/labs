...
import com.hc.springboot.lab04.rabbitmqdemo.message.Demo16Message;
...
public class RabbitConfig {
  ...
  public static class DirectExchangeDemoConfiguration {
    ...
    public Binding demo16Binding() {
      return BindingBuilder.bind(demo16Queue()).to(demo16Exchange())
          .with(Demo16Message.ROUTING_KEY);
    }
