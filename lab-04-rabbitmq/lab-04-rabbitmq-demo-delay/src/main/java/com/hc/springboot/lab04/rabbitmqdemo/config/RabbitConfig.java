...
public class RabbitConfig {
  ...
  public static class DirectExchangeDemoConfiguration {
    ...
    public Binding demo08Binding() {
      return BindingBuilder.bind(demo08Queue()).to(demo08Exchange())
          .with(Demo08Message.ROUTING_KEY);
    }

    @Bean
    public Binding demo08DelayBinding() {
      return BindingBuilder.bind(demo08DelayQueue()).to(demo08Exchange())
          .with(Demo08Message.DELAY_ROUTING_KEY);
    }
  }
}
